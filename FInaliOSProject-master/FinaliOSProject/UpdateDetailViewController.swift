...
//  FinaliOSProject
//
//  Created by Jaspreet Singh on 2020-01-21.
...
class UpdateDetailViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        latitudeTxtField.text = String(singleUserObject.latitude)
        longitudeTxtField.text = String(singleUserObject.longitude)
        birthdayTxtField.text = formatter.string(from: singleUserObject.birthday!)
        imageView.image = singleUserObject.photoImage
        
        UserDefaults.standard.set(singleUserObject.country, forKey: "country")
...
extension UpdateDetailViewController{
    ...
    @IBAction func submitBtnTapped(_ sender: Any) {
        ...
        updateRecord(userData: singleUserObject,name: nameTxtField.text!, gender: genderTxtField.text!, country: countryTxtField.text!, latitude: Double(latitudeTxtField.text!)!, longitude: Double(longitudeTxtField.text!)!, birthday: formatter.date(from: birthdayTxtField.text ?? "") ?? Date() , userImg: NSNumber(value: index))
